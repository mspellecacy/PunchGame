...
function scene:createScene( event )
	...
	image = display.newImage("startpage_bg.png");
	group:insert(image);

	playBtn = display.newImageRect("play.png", 212, 112);
	playBtn:setReferencePoint( display.CenterReferencePoint )
	playBtn.x, playBtn.y = display.contentWidth * 0.5, display.contentHeight * 0.5;
